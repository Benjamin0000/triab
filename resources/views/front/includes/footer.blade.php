				...
				<div class="row">
					<div class="col-lg-4">
						<div class="single-widget">
							<a href="/">
								<img src="/assets/frontpage/img/logo.png" width="50" alt="Image">
							</a>

							<p>
                                Triab Global Resources is a network marketing company dedicated to delivering high-quality products and services to its members at the most competitive prices.
                            </p>
		...
		<footer class="footer-bottom-area">
			<div class="container">
				<div class="copy-right">
					<p>© Copyright {{date('Y')}} Triab Global Resources. All Rights Reserved</p>
				</div>
			</div>
		</footer>
        ...
        <!-- Popper JS -->
        <script src="/assets/frontpage/js/popper.min.js"></script>
        <!-- Bootstrap JS -->
        <script src="/assets/frontpage/js/bootstrap.min.js"></script>
        <!-- Meanmenu JS -->
		<script src="/assets/frontpage/js/jquery.meanmenu.js"></script>
        <!-- Wow JS -->
        <script src="/assets/frontpage/js/wow.min.js"></script>
        <!-- Owl Carousel JS -->
		<script src="/assets/frontpage/js/owl.carousel.js"></script>
        <!-- Owl Magnific JS -->
		...
		<!-- Contact JS -->
		<script src="/assets/frontpage/js/contact-form-script.js"></script>
		<!-- Ajaxchimp JS -->
		<script src="/assets/frontpage/js/jquery.ajaxchimp.min.js"></script>
        <!-- Custom JS -->
		<script src="/assets/frontpage/js/custom.js"></script>
    </body>
</html>
