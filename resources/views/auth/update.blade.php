...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-4 col-md-6 bg-white p-3" style="border-radius: 10px">
            ...
            @endif 
            <form action="{{route('change_password')}}" method="POST" class="form-validate is-alter" autocomplete="off">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        ...
                        <input autocomplete="new-password" type="password" name="password" class="form-control form-control-lg" required id="password" placeholder="Password">
                    </div>
